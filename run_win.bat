...
cl.exe /MT /c /W3 /WX- /EHsc /MD helper.cpp
cl.exe /MT /c /W3 /WX- /EHsc /MD extra/win.cpp

link.exe /DEBUG:NONE /OUT:"helper.exe" .\clip\Release\clip.lib user32.lib gdi32.lib /SUBSYSTEM:CONSOLE /machine:X86 win.obj helper.obj
