...
cl.exe /D NDEBUG /c /W3 /WX- /EHsc /MD wait_win.cpp

link.exe /OUT:"helper.exe" .\clip\Release\clip.lib user32.lib gdi32.lib /SUBSYSTEM:CONSOLE /machine:X86 wait_win.obj helper.obj
